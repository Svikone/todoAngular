...
let AllCardsComponent = class AllCardsComponent {
    ...
    remove(_id) {
        this.http.delete(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_3__["EApiUrls"].CARD_REMOVE + _id).subscribe(value => {
            this.allCards();
        }, error => {
            // error - объект ошибки
        });
    ...
    allCards() {
        if (this.feature == _core_enums_page_mode_enums__WEBPACK_IMPORTED_MODULE_5__["EPageMode"].SHARED) {
            this.http.get(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_3__["EApiUrls"].CARD_ALL_SHARED).subscribe((value) => {
                this.allcards = value;
            }, error => {
                // error - объект ошибки
            });
            ...
            this.http.get(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_3__["EApiUrls"].CARD_ALL).subscribe((value) => {
                this.allcards = value;
            }, error => {
                // error - объект ошибки
            });
...
AllCardsComponent.ctorParameters = () => [
...
let CardComponent = class CardComponent {
    constructor(_router, http, activateRoute) {
    ...
    shared(id) {
        ...
        this.http.post(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_5__["EApiUrls"].USER_ADD_SHARED, { _id: id, _idShared: _idShared }).subscribe(value => {
        }, error => {
        });
    }
    flipIt() {
    ...
    removeShared(shared, idCard) {
        this.http.post(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_5__["EApiUrls"].CARD_DELETE_SHARED, { _idCard: idCard, shared: shared }).subscribe(value => {
        }, error => {
        });
    }
    searchUsers(searchValue) {
        this.http.post(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_5__["EApiUrls"].CARD_SEARCH_USERS, { _searchValue: searchValue }).subscribe((value) => {
            this.allusers = value;
        }, error => {
        });
    }
...
let CreateCardComponent = class CreateCardComponent {
    constructor(fb, http) {
        this.fb = fb;
        this.http = http;
...
CreateCardComponent.ctorParameters = () => [
...
let EditCardComponent = class EditCardComponent {
    constructor(fb, http, activateRoute, _router) {
        this.fb = fb;
        this.http = http;
        this.activateRoute = activateRoute;
        this._router = _router;
    ...
    getCardId() {
        this.http.get(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_4__["EApiUrls"].CARD + this.id).subscribe((value) => {
            this.card = value;
            this.formInit();
        }, error => {
            // error - объект ошибки
...
EditCardComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _service_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"] },
...
let HeaderComponent = class HeaderComponent {
    ...
    getUserId() {
        this.http.get(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_3__["EApiUrls"].USER_GET_ID).subscribe((value) => {
            this.user = value;
        }, error => {
        });
    }
...
let HttpService = class HttpService {
    ...
    get(url) {
        this.httpOptions = this.reCoolHeader();
        return this.http.get(this.fullUrl() + url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((err) => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(err)));
    }
    delete(url, body = {}) {
        this.httpOptions = this.reCoolHeader();
...
let SigninComponent = class SigninComponent {
    ...
    onSubmit() {
        ...
        this.http.post(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_5__["EApiUrls"].USER_SIGNIN, { user }).subscribe((value) => {
            const data = value;
...
let SignoutComponent = class SignoutComponent {
    ...
    onSubmit() {
        ...
        this.http.post(_core_enums_api_urls_enum__WEBPACK_IMPORTED_MODULE_4__["EApiUrls"].USER_ADD, { user }).subscribe(value => {
            this._router.navigate(['user/signin']);
        }, error => {
            // error - объект ошибки
        });
